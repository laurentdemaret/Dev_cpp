...
set_target_properties(Ceres::ceres PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libceres.2.1.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libceres.3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS Ceres::ceres )
list(APPEND _IMPORT_CHECK_FILES_FOR_Ceres::ceres "${_IMPORT_PREFIX}/lib/libceres.2.1.0.dylib" )
