...
// Warning : Bit is unsigned int but must be 0 or 1
...
bool WBitStream::SaveValue(unsigned int NbBitsUsed, unsigned int ValueToEncode, char* pc_ErrorMessage/*=0*/)
{
  bool b_Error = (unsigned int)(1 << NbBitsUsed) <= ValueToEncode;
  if (b_Error)
  {
